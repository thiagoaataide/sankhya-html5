...
<main class="dashboard">
    ...
    <section id="table-panel" class="table-panel">
        ...
        <div class="table-wrap">
            <table>
                <thead><tr>
                    <th>OS</th><th>Pedido</th><th>NF</th><th>Parceiro</th><th>Vendedor</th><th>Executante</th>
                    <th>Classificação</th><th>Natureza</th><th>Horas</th><th>Valor total</th><th>Valor unitário</th>
                    <th>Faturado</th><th>Faturar</th><th>Autorizado</th><th>Entrada</th><th>Início execução</th>
                </tr></thead>
